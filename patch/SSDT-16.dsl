 ...
 *
 * Disassembly of SSDT-16.aml, Fri Mar 23 17:19:09 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001C8D (7309)
 *     Revision         0x01
 *     Checksum         0xF4
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (NVAF, IntObj)    // (from opcode)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        Method (GC6I, 0, Serialized)
        {
            ...
            While (LNotEqual (\_SB.GGIV (0x01050017), One))
            {
                Sleep (One)
            }
        ...
        Method (GC6O, 0, Serialized)
        {
            ...
            If (LEqual (\_SB.GGIV (0x01050017), One))
            {
                \_SB.PCI0.SGPO (SGGP, Zero, 0x0105000E, Zero, One)
                While (LNotEqual (\_SB.GGIV (0x01050017), Zero))
                {
                    Sleep (One)
                }
        ...
        {
            If (LEqual (\_SB.GGIV (0x01050017), Zero))
            {
