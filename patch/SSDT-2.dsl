 ...
 *
 * Disassembly of SSDT-2.aml, Fri Mar 23 17:19:09 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000029BF (10687)
 *     Revision         0x02
 *     Checksum         0xDF
 *     OEM ID           "PegSsd"
...
DefinitionBlock ("", "SSDT", 2, "PegSsd", "PegSsdt", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.MUT0, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.EC0_.VGAT, UnknownObj)    // (from opcode)
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Method (PGON, 1, Serialized)
        {
            ...
            {
                Acquire (\_SB.PCI0.LPCB.EC0.MUT0, 0x2000)
                Store (One, \_SB.PCI0.LPCB.EC0.VGAT)
        ...
        Method (PGOF, 1, Serialized)
        {
            ...
            {
                Acquire (\_SB.PCI0.LPCB.EC0.MUT0, 0x2000)
                Store (Zero, \_SB.PCI0.LPCB.EC0.VGAT)
                Release (\_SB.PCI0.LPCB.EC0.MUT0)
            }
